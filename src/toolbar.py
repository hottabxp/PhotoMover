...
def create_toolbar(instance):
    ...
    prew = QAction(QIcon('./src/assets/back.png'), "", instance)
    prew.triggered.connect(instance.prew_triggered)

    exit_button = QAction(QIcon('./src/assets/exit.png'), "", instance)

    settings_button = QAction(QIcon('./src/assets/setting.png'), "", instance)

    nxt = QAction(QIcon('./src/assets/next.png'), '', instance)
    nxt.triggered.connect(instance.nxt_triggered)

    set_wlp = QAction(QIcon('./src/assets/wallpaper.png'), '', instance)
